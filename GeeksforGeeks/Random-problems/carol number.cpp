...
/**
    carol numbers are the numbers which can be represented in the form
    A Carol number is an integer of the form 4^n – 2^(n+1) – 1. An equivalent formula is (2n-1)^2 – 2
    **/
...
void carol_numbers(int n, vector<int> &carol)
{
    int fir,sec;
    int num;
...
int main()
{
    ...
    vector<int> carol;
    // generate carol upto n
    carol_numbers(n, carol);
