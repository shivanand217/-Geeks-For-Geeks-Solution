...
/** using special formula for nth fibonacci numbers directly first find the nth fibonacci numbers
...
LL int ans = nth_fibonacci_number(n);

//cout<<ans<<endl;

int cnt_digit = cnt_digits(ans);
cout<<cnt_digit<<endl;
