...
void prime_fac(int n,vector<int> &prime_factors, vector<int> &prime)
{
    int k;
...
if(binary_search(prime.begin(), prime.end(), k))
{
    cout<<"not a composite number"<<endl;
}
else
{
    int sum = sum_of_digits(k);
    int sum_2 =0 ;

    vector<int> prime_factors;
    prime_fac(k, prime_factors, prime);
